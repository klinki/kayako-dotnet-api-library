...
namespace KayakoRestApi.Core.Troubleshooter
{
    public class TroubleshooterCategoryRequest : RequestBaseObject
    {
        ...
        public static TroubleshooterCategoryRequest FromResponseData(TroubleshooterCategory responseData) => FromResponseType<TroubleshooterCategory, TroubleshooterCategoryRequest>(responseData);
