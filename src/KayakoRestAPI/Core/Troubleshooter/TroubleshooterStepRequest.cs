...
namespace KayakoRestApi.Core.Troubleshooter
{
    public class TroubleshooterStepRequest : RequestBaseObject
    {
        ...
        public static TroubleshooterStepRequest FromResponseData(TroubleshooterStep responseData) => FromResponseType<TroubleshooterStep, TroubleshooterStepRequest>(responseData);
