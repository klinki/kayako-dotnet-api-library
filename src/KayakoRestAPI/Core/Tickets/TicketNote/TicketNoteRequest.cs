...
namespace KayakoRestApi.Core.Tickets.TicketNote
{
    public class TicketNoteRequest : RequestBaseObject
    {
        ...
        public static TicketNoteRequest FromResponseData(TicketNote responseData) => FromResponseType<TicketNote, TicketNoteRequest>(responseData);

        public static TicketNote ToResponseData(TicketNoteRequest requestData) => ToResponseType<TicketNoteRequest, TicketNote>(requestData);
    }
}