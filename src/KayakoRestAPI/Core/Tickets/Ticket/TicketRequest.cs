...
namespace KayakoRestApi.Core.Tickets.Ticket
{
    public class TicketRequest : RequestBaseObject
    {
        ...
        /// <summary>
        ///     If dispatched as "1" then the User Id is looked up based on the email address, if none is found, the system ends up
        ///     creating a new user based on the information supplied.
        /// </summary>
        [EitherField("UserId|StaffId")]
        ...
        [EitherField("AutoUserId|UserId")]
        public int? StaffId { get; set; }

        /// <summary>
        ///     The Id of staff user who created the ticket
        /// </summary>
        [EitherField("AutoUserId|StaffId")]
        ...
        /// </summary>
        [OptionalField]
        public TicketRequestCreationType? CreationType { get; set; }

        public static TicketRequest FromResponseData(Ticket responseData) => FromResponseType<Ticket, TicketRequest>(responseData);

        public static Ticket ToResponseData(TicketRequest requestData) => ToResponseType<TicketRequest, Ticket>(requestData);
    }
}