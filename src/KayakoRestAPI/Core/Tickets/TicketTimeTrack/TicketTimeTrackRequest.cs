...
namespace KayakoRestApi.Core.Tickets.TicketTimeTrack
{
    public class TicketTimeTrackRequest : RequestBaseObject
    {
        ...
        /// <summary>
        ///     The staff identifier of the worker. If not specified, the staff user creating this entry will be considered as the
        ///     worker.
        /// </summary>
        ...
        public static TicketTimeTrackRequest FromResponseData(TicketTimeTrack responseData) => FromResponseType<TicketTimeTrack, TicketTimeTrackRequest>(responseData);

        public static TicketTimeTrack ToResponseData(TicketTimeTrackRequest requestData) => ToResponseType<TicketTimeTrackRequest, TicketTimeTrack>(requestData);
    }
}