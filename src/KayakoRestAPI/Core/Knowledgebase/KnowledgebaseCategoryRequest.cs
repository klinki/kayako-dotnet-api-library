...
namespace KayakoRestApi.Core.Knowledgebase
{
    public class KnowledgebaseCategoryRequest : RequestBaseObject
    {
        ...
        public static KnowledgebaseCategoryRequest FromResponseData(KnowledgebaseCategory responseData) => FromResponseType<KnowledgebaseCategory, KnowledgebaseCategoryRequest>(responseData);

        public static KnowledgebaseCategory ToResponseData(KnowledgebaseCategoryRequest requestData) => ToResponseType<KnowledgebaseCategoryRequest, KnowledgebaseCategory>(requestData);
    }
}