...
namespace KayakoRestApi.Core.Knowledgebase
{
    public class KnowledgebaseArticleRequest : RequestBaseObject
    {
        ...
        public static KnowledgebaseArticleRequest FromResponseData(KnowledgebaseArticle responseData) => FromResponseType<KnowledgebaseArticle, KnowledgebaseArticleRequest>(responseData);
