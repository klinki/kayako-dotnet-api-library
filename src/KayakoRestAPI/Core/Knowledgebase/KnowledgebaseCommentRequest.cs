...
namespace KayakoRestApi.Core.Knowledgebase
{
    public class KnowledgebaseCommentRequest : RequestBaseObject
    {
        ...
        public static KnowledgebaseCommentRequest FromResponseData(KnowledgebaseComment responseData) => FromResponseType<KnowledgebaseComment, KnowledgebaseCommentRequest>(responseData);

        public static KnowledgebaseComment ToResponseData(KnowledgebaseCommentRequest requestData) => ToResponseType<KnowledgebaseCommentRequest, KnowledgebaseComment>(requestData);
    }
}