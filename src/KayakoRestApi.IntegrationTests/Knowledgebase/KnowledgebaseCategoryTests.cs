...
namespace KayakoRestApi.IntegrationTests.Knowledgebase
{
    ...
    public class KnowledgebaseCategoryTests : UnitTestBase
    {
        ...
        {
            var knowledgebaseCategories = TestSetup.KayakoApiService.Knowledgebase.GetKnowledgebaseCategories();
        ...
        public void GetKnowledgebaseCategory()
        {
            ...
            var knowledgebaseCategoryToGet = knowledgebaseCategories[new Random().Next(knowledgebaseCategories.Count)];

            Trace.WriteLine("GetKnowledgebaseCategory using knowledgebase category id: " + knowledgebaseCategoryToGet.Id);

            var knowledgebaseCategory = TestSetup.KayakoApiService.Knowledgebase.GetKnowledgebaseCategory(knowledgebaseCategoryToGet.Id);
